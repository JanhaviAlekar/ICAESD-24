        ...
        <>
            <div className="flex justify-center">
                <div className="max-w-6xl p-6 leading-7">
                    ...
                    <Link to="https://easychair.org/conferences/?conf=ICAIISD2025" class="text-white bg-[#E30022]  transition-transform transform-gpu hover:-translate-y-2 hover:shadow-lg py-2 my-4 px-4 rounded-full text-lg font-semibold ">Submit your Paper</Link>
                    ...
                    <p className="mb-4  mt-4">
                        <b> Upload the full paper through the Conference submission Platform: Easy-Chair
                            <br />(https://easychair.org/conferences/?conf=ICAIISD2025)</b>
                    </p>
