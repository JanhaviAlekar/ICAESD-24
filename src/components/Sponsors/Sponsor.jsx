...
function Sponsor({word ,users}) {
  return (
    <>
      ...
      <p className="text-3xl font-bold mb-4 lg:mx-10 sm:mx-2 pb-6 lg:pb-4"><span className="underline underline-offset-8 decoration-4 decoration-[#33358c]">{word.substring(0,3)}</span>{word.substring(3)}</p>
