...
export const Venue = () => {
    return (
        <>
 <div className="lg:px-24 px-4  mb-10 py-6 bg-[#FE3A4A]  text-[#ffd901] flex flex-col md:flex-row md:justify-evenly md:items-center">
...
<div className="lg:px-24 px-4  mb-10 py-6 bg-[#ffd901] text-[#FE3A4A]  flex flex-col md:flex-row md:justify-evenly md:items-center">
    <div className="mb-6 lg:mb-0">
    <div className="mb-4">
        <p className="font-bold text-3xl text-center mb-4">Venue</p>
    </div>
    ...
    <div>
    <a href="https://www.google.com/maps/place/Government+College+of+Engineering/@20.9571631,77.7567616,15z/data=!4m2!3m1!1s0x0:0x41ba68e6a59d67ab?sa=X&ved=1t:2428&ictx=111" class="text-[#ffd901] bg-[#FE3A4A]  py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Directions</a>
