        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-4 text-lg text-justify font-medium text-gray-800">
              ...
              <li>
                Ensure proper grammar, clarity and coherence in English language
                of the paper.
              </li>
              <li>
                Upload the full paper through the official conference submission
                portal:
                <br />
                <a
                  href="https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FICAIISD2025%2FSubmission%2FManage"
          ...
          <section>
            <h2 className="text-3xl font-bold mb-4 tracking-wide leading-snug">
              ...
              uscript Review/Paper Acceptance Process
            </h2>
            <ul className="list-disc ml-6 space-y-3 text-lg text-justify font-medium text-gray-800">
              ...
              <li>
                Papers submitted in IEEE Two column format only will be
                considered for further processing.
              </li>
              <li>
                Papers received in proper format will be checked for Plagiarism
                to confirm originality of the submitted work. Manuscript with
                less than permissible plagiarism will be accepted for further
                processing else will be sent back to the author for revision.
              </li>
              <li>
              ...
              <li>
                Manuscript approved by the reviewers will be considered for
                final presentation and publication process.
              </li>
              <li>
                The acceptance of the manuscript for presentation in the
                conference will be notified to the author by the respective
                Co-chairs.
              </li>
            </ul>
            <p className="mt-4 text-lg font-medium text-gray-800">
              "Authors must read the guidelines carefully and use the
              appropriate article template."
            </p>
          </section>
        </div>
      </div>
